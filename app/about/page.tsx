    ...
    <>
              ...
              <Reveal key={entry.period} delay={0.08 * i}>
                <li className="grid gap-6 md:grid-cols-12 md:gap-10 border-t border-[color:var(--color-rule)] pt-10">
                  ...
                  <div className="md:col-span-9">
                    <p className="font-display text-2xl md:text-3xl text-[color:var(--color-fg)]">
                      {entry.role}
                    </p>
                    <p className="mt-1 text-sm text-[color:var(--color-fg-muted)]">
                      {entry.org}
                    </p>
                    <p className="mt-5 max-w-2xl leading-relaxed text-[color:var(--color-fg-muted)]">
                      {entry.body}
                    </p>
                  </div>
                </li>
      ...
      <section className="relative overflow-hidden bg-[color:var(--color-bg-elevated)] border-y border-[color:var(--color-rule)]">
        ...
        <div className="relative mx-auto max-w-6xl px-6 md:px-10 py-28 md:py-40">
          ...
          <Reveal delay={0.15}>
            <blockquote className="mt-10 max-w-4xl">
              <p className="font-display text-4xl md:text-6xl leading-tight">
                <span className="text-[color:var(--color-accent)] opacity-60">
                  &ldquo;
                </span>
          ...
          <Reveal delay={0.3}>
            <p className="mt-10 max-w-2xl leading-relaxed text-[color:var(--color-fg-muted)]">
          ...
          <ul className="mt-14 grid gap-px bg-[color:var(--color-rule)] border border-[color:var(--color-rule)] rounded-2xl overflow-hidden md:grid-cols-3">
            {about.why.map((item, i) => (
              ...
              >
                ...
                <p className="mt-4 leading-relaxed text-[color:var(--color-fg-muted)]">
                  {item.body}
                </p>
              </Reveal>
            ))}
